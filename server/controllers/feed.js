...
export const getFeed = async (req, res) => {
	try {
		...
		const viewerSkills = viewer.profile ? viewer.profile.getSkillsArray() : []
		const viewerInterests = viewer.profile ? viewer.profile.getInterestsArray() : []
		...
		const scoredPosts = posts.map((post) => {
			...
			const authorSkills = author && author.profile ? author.profile.getSkillsArray() || [] : []
