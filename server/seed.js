...
export const seedDatabase = async () => {
	try {
		...
		// await Internship.deleteMany({}) // Clear existing internships if any
		// await Application.deleteMany({}) // Clear existing applications if any
            ...
            await Internship.insertMany([
				{
					...
					description:
						'Join Google engineering team to build scalable web applications using modern MERN stack. Work on real-world projects with senior mentors.',

					eligibilityCriteria:
						'Minimum CGPA 3.3, CSE/SE majors, proficiency in JavaScript and Data Structures.',
...

				{
					...
					description:
						'Collaborate with the Microsoft UI design team to craft fluid, accessible, and high-performance web components.',

					eligibilityCriteria:
						'Current 3rd or 4th year student, strong portfolio of React web projects.',
...

				{
					...
					description:
						'Design and deploy robust RESTful API microservices with high throughput and low latency database connections.',

					eligibilityCriteria:
						'Good foundation in database management, REST API design, and asynchronous JS.',
...

				{
					...
					description:
						'Build predictive career matching models and student skill analytics dashboards.',

					eligibilityCriteria:
						'Prior coursework or projects in Machine Learning, Python, and PyTorch/TensorFlow.',
...

				{
					...
					description:
						'Auditing authentication protocols, enforcing JWT token security, and safeguarding cloud deployment pipelines.',

					eligibilityCriteria:
						'Basic understanding of OS security, Linux shell scripting, and web authentication.',
